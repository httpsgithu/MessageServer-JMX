 ...
 * System Properties
   -----------------
     Specify the following system properties in your web container:
         ...
         -Dwebconsole.jmx.url=<jmx url to the broker> (f.e. component:jmx:rmi:///jndi/rmi://localhost:1099/jmxrmi)
...
as follows (system properties shown, but this option is also available when using JNDI):
   ...
   -Dwebconsole.jmx.url=component:jmx:rmi:///jndi/rmi://serverA:1099/jmxrmi,component:jmx:rmi:///jndi/rmi://serverB:1099/jmxrmi
